...
const FlashMessage = () => <Consumer>
    ...
    {({ state, ...context }) => state.message && <small className="flash-message">
        ...
        <div id="AlertLoginErr" class="animated fadeInDown alert alert-danger alert-dismissible fade show" role="alert">
            {/* Custom User OR Password Fail Message  */}
            <strong id="LoginFailed" className="font-weight-bold"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Login Failed: </strong> {state.message = "You have entered invalid credentials, please check to make sure you've entered the correct username and password."}
